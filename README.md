...
The source code for https://svelte.dev, including all the documentation, lives in here [site](site) directory. The site is built with [Sapper](https://sapper.svelte.dev).
